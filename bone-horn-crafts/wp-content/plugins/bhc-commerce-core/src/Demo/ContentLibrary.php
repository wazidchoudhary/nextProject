	...
	public static function pages(): array {
		return [
			...
			'shipping-delivery'    => [
				...
				'excerpt'  => 'Dispatch times, transit windows and how export parcels are documented.',
				'template' => 'page-narrow',
				'menu'     => 'footer',
				'content'  => '<p>Orders are picked and packed from the workshop. Items showing a lead time need cutting or finishing first; that time is added before dispatch, and it is shown on the product page rather than discovered afterwards.</p>'
					. '<h2>Dispatch</h2>'
					. '<p>In-stock items leave within one working day. Items with a stated lead time leave within that window. If a batch runs late you will be emailed before your dispatch date, not after it.</p>'
					. '<h2>Transit windows</h2>'
					. '<table><thead><tr><th>Destination</th><th>Typical transit</th></tr></thead><tbody>'
					. '<tr><td>India (domestic)</td><td>2-5 working days</td></tr>'
					. '<tr><td>United Kingdom</td><td>5-8 working days</td></tr>'
					. '<tr><td>Europe</td><td>6-10 working days</td></tr>'
					. '<tr><td>United States &amp; Canada</td><td>6-11 working days</td></tr>'
					. '<tr><td>Australia &amp; New Zealand</td><td>7-13 working days</td></tr>'
					. '</tbody></table>'
					. '<p>These are transit times after dispatch, not from the moment you order, and they exclude customs holds.</p>'
					. '<h2>Customs and documentation</h2>'
					. '<p>Every export parcel ships with an accurate commercial invoice listing the material description, HS code, quantity and declared value. We do not mark parcels as gifts or under-declare value; doing so puts your parcel at risk, not ours.</p>'
					. '<h2>Duties and taxes</h2>'
					. '<p>Import duty, VAT, GST or sales tax charged on arrival is payable by the recipient. Rates depend on your country and the value of the shipment. If a parcel is refused at customs and returned, the return freight is deducted from any refund.</p>',
			],
			'returns-refunds'      => [
				'title'    => 'Returns &amp; Refunds',
				'excerpt'  => 'Thirty days to change your mind on unworked material.',
				'template' => 'page-narrow',
				'menu'     => 'footer',
				'content'  => '<p>Material that is not right for your build can come back within thirty days of delivery, provided it has not been cut, drilled, sanded or dyed.</p>'
					. '<h2>What can be returned</h2>'
					. '<ul><li>Unworked material in its original condition</li><li>Sealed sets and packs that have not been opened</li><li>Anything that arrived damaged or is not what you ordered</li></ul>'
					. '<h2>What cannot</h2>'
					. '<ul><li>Material that has been worked in any way — once it is cut it is yours</li><li>Custom-cut sizes made to your dimensions</li><li>Workshop-grade seconds, which are sold as flawed material</li></ul>'
					. '<h2>How it works</h2>'
					. '<p>Email the order number and what you would like to return. You will get a returns reference; write it on the parcel. Return freight is at your cost unless the item was damaged, faulty or incorrectly supplied, in which case we cover it.</p>'
					. '<h2>Refunds</h2>'
					. '<p>Refunds are issued to the original payment method within five working days of the parcel arriving and being checked. Original outbound shipping is refunded when the fault was ours.</p>'
					. '<h2>Natural variation is not a fault</h2>'
					. '<p>Colour, figure and small inclusions vary between pieces of the same listing. Our photographs show representative material and every listing states the grading band. Variation within that band is not grounds for a fault return, though it is always grounds for an email if you think we have misjudged it.</p>',
			],
			'privacy-policy'       => [
				...
				'content'  => '<p><em>This is demonstration copy for a reference build. A live store should have this reviewed against the regulations that apply to it.</em></p>'
					...
					. '<p>When you place an order: name, delivery and billing address, email address and phone number. The phone number is required by couriers for export parcels. Payment details are handled by the payment provider and never reach this site.</p>'
					. '<p>When you browse: a session cookie for the cart, and — only if you use them — a signed cookie holding the product IDs on your wishlist or recently viewed list. Those cookies contain product IDs and nothing else: no name, no email, no tracking identifier.</p>'
					. '<h2>What is not collected</h2>'
					. '<p>No advertising trackers, no third-party analytics, no cross-site profiling, no data sold or shared with brokers.</p>'
					. '<h2>How long it is kept</h2>'
					. '<p>Order records are kept for as long as tax and customs rules require. Account data is kept until you ask for it to be deleted. Server logs are rotated on a short cycle.</p>'
					. '<h2>Your choices</h2>'
					. '<p>You can ask for a copy of your data, ask for it to be corrected, or ask for your account and its data to be deleted, except where a record must be retained for tax purposes.</p>',
			],
			'terms-conditions'     => [
				...
				'content'  => '<p><em>This is demonstration copy for a reference build and is not legal advice.</em></p>'
					. '<h2>Orders</h2>'
					. '<p>An order is an offer to buy. It is accepted when the goods are dispatched. If an item turns out to be unavailable after you order — which happens with one-off pieces — you are told and refunded rather than substituted without asking.</p>'
					. '<h2>Pricing</h2>'
					. '<p>Prices are in US dollars and exclude import duties and taxes charged on arrival. Quantity pricing is applied automatically in the cart when the threshold is reached.</p>'
					. '<h2>Description of goods</h2>'
					. '<p>Photographs show representative material. Dimensions are nominal with a tolerance of ±1mm on thickness. Natural variation in colour and figure is expected and described in each listing.</p>'
					. '<h2>Liability</h2>'
					. '<p>Material is sold as raw stock for skilled work. Cutting, grinding and finishing carry risk; appropriate extraction, eye protection and dust protection are the responsibility of the person doing the work.</p>'
					. '<h2>Governing terms</h2>'
					. '<p>Nothing here limits statutory rights that apply where you live.</p>',
			],
			'material-size-guide'  => [
