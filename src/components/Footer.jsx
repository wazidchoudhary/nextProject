      ...
      <div className="row justify-content-between">
        <div className="col-lg-5 col-md-6 col-sm-12">
          <div className="single-footer pb--50">
            ...
            <p>Where masterful artistry in Bone, Horn, Acrylic, and Wood blends seamlessly with dependable quality, unmatched customer service, and the allure of unique masterpieces. Dive into our world of timeless beauty and handcrafted perfection.</p>
            <h3 className="footer-title mb--25 mt--25">
              Follow Us
            </h3>
        ...
        <div className="col-lg-2 col-md-6 col-sm-4">
          <div className="single-footer pb--50">
            <h3 className="footer-title  mb--30">
              Products
            </h3>
      ...
      <div className="row">
        <div className="col-md-6 text-center text-md-start">
          <div className="copyright-text">
            <p>© AS International, 2023. Made with<i className="fa fa-heart text-danger ms-1" /> by <Link href="https://krapton.com" target="_blank" className="author">Krapton Inc</Link>.
            </p></div>
        </div>
