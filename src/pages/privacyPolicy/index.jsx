            ...
            <div className="container-lg pt-5">
                <div className="section-title" style={{ backgroundColor: '#f6f6f6', padding: '50px' }}>
                    ...
                    <article className="policyArticle" style={{ textAlign: 'justify' }}>
                        ...
                        <p>
                            We collect personal information when you voluntarily provide it to us. For example, when you register on our site, place an order or subscribe to our newsletter.
                        </p>
                        
                        <h5>Use of Your Information</h5>
                        <p>
                            The personal information we collect allows us to keep you posted on our latest product announcements, updates, and upcoming events. If you don't want to be on our mailing list, you can opt-out anytime.
                        </p>

                        <h5>Cookies</h5>
                        <p>
                            We use cookies to help us remember and process the items in your shopping cart, understand and save your preferences for future visits, and compile aggregate data about site traffic and site interactions.
                        </p>
                        ...
                        <h5>Contacting Us</h5>
                        <p>
                            If there are any questions regarding this privacy policy, you may contact us using the information below: [your_email@example.com]
                        </p>
                    </article>
                </div>
            </div>
